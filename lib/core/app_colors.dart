...
class AppColors {
  ...
  static Color primary = Color(0xFFFA264D);
  static Color onPrimary = Color(0xFFFFFFFF);

  // Not used for now.
  static Color secondary = Color(0xFF009468);
  static Color onSecondary = Color(0xFFFFFFFF);

  // Error color.
  static Color error = Color(0xFFFF1111);
  ...
  static Color outline = Color(0xFF3A3A3A);
  static Color shadow = Color(0xFF3A3A3A);

  // For text score color.
  static Color greenFlag = Color(0xFF009468);
  static Color orangeFlag = Color(0xFFFFAA2B);
  static Color redFlag = Color(0xFFFA264D);
}
